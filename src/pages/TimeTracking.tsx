        ...
        <div className="md:col-span-9 space-y-6">
          ...
          <div className="card-glass rounded-xl p-6">
            {isAddingEntry ? <NewTimeEntry date={selectedDate} onClose={handleCloseAddEntry} onSuccessfulAdd={handleCloseAddEntry} /> : <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <button className="bg-success hover:bg-success/90 text-white font-medium py-2 px-4 rounded-md flex items-center gap-2 shadow-sm timetrack-btn" onClick={() => setIsAddingEntry(true)}>
                  + Add time entry
                </button>
              </div>}
          </div>
